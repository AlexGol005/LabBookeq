...
def export_base_kinematicviscosity_xls(request, pk, MODEL):
    ...
    # переписка стилей чтобы увеличить шрифт
    style_plain.font.height = 20 * 11
    style_plain_nobor_r.font.height = 20 * 11
    style_headers.font.height = 20 * 11
    style_2dp.font.height = 20 * 11
    style_date.font.height = 20 * 11
    style_5dp.font.height = 20 * 11
