...
TYPE = [('путешествия', 'путешествия'),('книги','книги'), ('фильмы','фильмы'), ('музеи','музеи'), ('учебные курсы','учебные курсы'), ('рецепты','рецепты'), ('покупки','покупки'), ('фотоальбом','фотоальбом'), ('прогулка','прогулка')] 
