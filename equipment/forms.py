...
class EquipmentCreateForm(forms.ModelForm):
    ...
    yearmanuf = forms.CharField(label='Год выпуска прибора', max_length=10000, initial=datetime.now().year,
                                widget=forms.TextInput(attrs={'class': 'form-control'}))
    manufacturer = AutoCompleteSelectField('manufacturer_tag', label='Производитель прибора', required=True, help_text='Начните вводить название организации', show_help_text=False)
