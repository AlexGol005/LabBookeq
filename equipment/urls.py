...
urlpatterns = [
    ...
    re_path(r'^export/xls/$', exel.export_me_xls, name='export_me_xls'),
    re_path(r'^export3/xls/$', exel.export_mustver_xls, name='export_mustver_xls'),
    ...
    re_path(r'^export1/xls/$/<int:pk>', exel.export_mecard_xls, name='export_mecard_xls'),
    re_path(r'^export111/xls/$/<int:pk>', exel.export_tecard_xls, name='export_tecard_xls'),
    re_path(r'^export10/xls/$/<int:pk>', exel.export_exvercard_xls, name='export_exvercard_xls'),
    re_path(r'^export100/xls/$/<int:pk>', exel.export_exvercardteste_xls, name='export_exvercardteste_xls'),
    re_path(r'^export2/xls/$/', exel.export_verificlabel_xls, name='export_verificlabel_xls'),
    ...
    re_path(r'^export70/xls/$', exel.export_metroyear_xls, name='export_metroyear_xls'),
    re_path(r'^export71/xls/$', exel.export_metroyearprice_xls, name='export_metroyearprice_xls'),
    re_path(r'^export72/xls/$', exel.export_metroyearcust_xls, name='export_metroyearcust_xls'),
    re_path(r'^export73/xls/$', exel.export_metronewyear_xls, name='export_metronewyear_xls'),
    re_path(r'^export74/xls/$', exel.export_planmetro_xls, name='export_planmetro_xls'),
    re_path(r'^export75/xls/$', exel.export_plan_purchaesing_xls, name='export_plan_purchaesing_xls'),
    re_path(r'^export80/xls/$', exel.export_maintenance_schedule_xls, name='export_maintenance_schedule_xls'),
    re_path(r'^export90/xls/$/<int:pk>', exel.export_meteo_xls, name='export_meteo_xls'),
]
