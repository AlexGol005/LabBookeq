...
class  ActivaqqchangeForm(forms.ModelForm):
    ...
    def __init__(self, ruser, *args, **kwargs):
        ...
        self.fields['verificator'].queryset = Verificators.objects.filter(companyName__in = Agreementverification.objects.filter(company__in = Company.objects.get(userid=ruser)))
